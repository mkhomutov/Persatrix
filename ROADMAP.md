...
> **Last updated**: 2026-09-23 (**EXP-001** harness PR 2 of 6 scores the memos and picks the rule: the 400-word cut, quality, per-plan agreement, the interval and verdicts, blinded packets — [#986](https://github.com/mkhomutov/Persatrix/pull/986), [harness plan](docs/experiments/EXP-001-harness.md). PR 1 ([#984](https://github.com/mkhomutov/Persatrix/pull/984)) merged. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
