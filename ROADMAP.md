...
> **Last updated**: 2026-06-04 (v0.3.6 **post-release follow-up** — `v0.3.6` tagged and the [GitHub Release "Web Console"](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.6) published 2026-06-04. Post-release ROADMAP hygiene: this `Last updated` refresh + the Merged PR History backfill for the full v0.3.6 cycle ([#492](https://github.com/mkhomutov/Persatrix/pull/492)–[#527](https://github.com/mkhomutov/Persatrix/pull/527)). v0.3.6 is ✅ Released; RFC 0048 stays `⚠️ Partially Implemented` (Slices 2–5 → v0.4.0+ / post-RFC 0039). **Planning update**: the v0.3.x tail is re-sequenced for conversation realism & usefulness ahead of v0.4.0 — new v0.3.7/v0.3.8/v0.3.9 rows below; RFC 0037/0038 confidentiality substrate deferred to the v0.4.0 on-ramp; deliberative reasoning (RFC 0028) added to v0.4.0. See the [sequencing amendment](docs/v0.3.x-sequencing.md#amendment-2026-06-04--re-sequence-the-v03x-tail-for-conversation-realism--usefulness-ahead-of-v040).)
