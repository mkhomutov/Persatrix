...
> **Last updated**: 2026-05-28 (v0.3.5 planning — opened the [v0.3.5 master plan](docs/v0.3.5-plan.md) (codename *Session Isolation*; RFC 0031 Phases 2–4 — the F-3 root-cause fix). `Current phase` / `Current milestone` flipped from v0.3.4 ✅ Released to v0.3.5 🚧 Planning; Version Map v0.3.5 row → 🚧 Planning. The drafted [RFC 0031 Phase 2 PR plan](docs/rfcs/0031-phase2-pr-plan.md) branch prefix swept `feature/v034-rfc0031p2-` → `feature/v035-rfc0031p2-` and its status flipped to Ready. RFC 0031 RFC-Master-Index status stays `⚠️ Partially Implemented (Phase 1)` until Phase 2 PR 1 opens; RFC 0033 stays `⚠️ Partially Implemented (Phases 1–2)` with Phase 3 (raw-ID rejection) observed-traffic gated to v0.3.5+.)
