...
> **Last updated**: 2026-07-02 (v0.3.11 in progress — RFC 0052 PR 4b-i: the deterministic bounded close — `max_rounds` + wallet soft-budget triggers with the artifact-bearing teardown. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
