...
> **Last updated**: 2026-07-10 (v0.3.11 in progress — RFC 0052 PR 7c-ii-b: the `agents.yaml` convene-timer writer (level bump + tick carry-forward) + `MT-AUTONOMOUS-003` (dark). See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
