...
> **Last updated**: 2026-07-14 (v0.3.11 — both headline RFCs (0052/0053) ✅ **Implemented**; the cuttable [RFC 0044 P1](docs/rfcs/0044-pr-plan.md) golden-trace eval fold-in is underway — PRs 1–3 (format, replay client, runner) landed, and PR 4a landed the first pre-0041 seed golden (EVAL-MEMORY-001, the dementia test); the event-asserting seeds (PR 4b) stay gated on RFC 0041 — ahead of the live acceptance MTs + release-prep. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
