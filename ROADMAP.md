...
> **Last updated**: 2026-06-04 (v0.3.7 in progress — RFC 0034 Phase 2 group working memory landed: replayed peer turns carry inline `[<peer_id>]: ` attribution and the fetch cache is multi-persona-correct ([0034 Phase 2 PR plan](docs/rfcs/0034-phase2-pr-plan.md), closeout). RFC 0034 → ⚠️ Partially Implemented (Phases 1–2); Phase 3 (tuning + cache LRU) remains. RFC 0030 relevance Tier A + the peer-voice prompt are the remaining realism workstreams.)
