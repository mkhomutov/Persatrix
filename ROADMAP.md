...
> **Last updated**: 2026-06-19 (RFC 0036 recall PR 1: dormant channel-store migration v10 — `messages_fts` FTS5 index + tests. RFC 0035 ledger merged, PRs 1–4.)
