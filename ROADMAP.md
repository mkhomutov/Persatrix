...
> **Last updated**: 2026-06-28 (v0.3.10 released-status flip — final pre-tag verification (PR 4) green on the post-bump tip; Version Map v0.3.10 → ✅ Released. Only the mechanical `v0.3.10` tag + GitHub Release remain.)
