...
> **Last updated**: 2026-09-26 (CI installs the agents' Python dependencies at the versions pinned in `.github/python-constraints.txt`; a weekly workflow offers newer pins once the Python checks pass on them. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
