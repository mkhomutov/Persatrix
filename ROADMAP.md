...
> **Last updated**: 2026-07-31 (v0.3.12 — 🚧 **Release prep**: implementation complete; the live release-gating MTs executed ([#796](https://github.com/mkhomutov/Persatrix/pull/796)) — eval-replay 5/5, `MT-AUTH-001` all six legs, `MT-PERSONA-CONFIDENTIALITY-001` pass, `MT-MEMORY-CROSSROOM-001` headline pass with the fresh-epoch leg Accepted-with-known-gap ([ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md), doesn't gate the tag) — two live-found fixes landed. [ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md) cut to v0.3.13 (maintainer call). Remaining: version bump + final pre-tag sweep + tag. See the [release-prep plan](docs/v0.3.12-release-prep-plan.md).)
