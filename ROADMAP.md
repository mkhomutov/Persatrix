...
> **Last updated**: 2026-06-30 (v0.3.11 in progress — RFC 0052 PR 4a: the close-path backend — roster-scaled (`1+N`) synthesis reserve + interaction-closed eviction + mandatory-chair gate, ships dark. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
