...
> **Last updated**: 2026-08-04 (v0.3.13 PR 2 — the [ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md) per-channel cascade-depth override — merged [#810](https://github.com/mkhomutov/Persatrix/pull/810); PR 3 opens the [ISSUE-0116](docs/issues/ISSUE-0116-fact-subject-renders-unquarantined.md) bounded subject header, the release's cuttable fold-in.)
> **Current phase**: v0.3.13 *Deferred calls closed* — planning opened 2026-08-03 ([plan](docs/v0.3.13-plan.md)); implementation next (ISSUE-0118 first — it gates the live MT arc; ISSUE-0114 + the ISSUE-0116 fold-in parallel; ISSUE-0121 = the release-prep live deliverable), then **v0.3.14** (multi-user isolation activation: ISSUE-0081/0082 + RFC 0040 Phase 1), then **v0.4.0** (Agent Organizations — RFC 0012 + RFC 0028 deliberative reasoning)
> **Current milestone**: v0.3.13 *Deferred calls closed* — 🔄 In progress ([plan](docs/v0.3.13-plan.md); PR 1 = ISSUE-0118 tool-recall scope threading). The story: **the v0.3.12 promise holds everywhere it was made** — a persona's own memory-tool recalls obey the same epoch/session isolation as injected memory ([ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md)), the person-identity half of cross-room memory is verified live ([ISSUE-0121](docs/issues/ISSUE-0121-crossroom-person-identity-legs-never-run-live.md), after the 0118 fix — one arc verifies both), and one channel's discussion length is tunable without retuning the fleet ([ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md)). Fold-in (cuttable): [ISSUE-0116](docs/issues/ISSUE-0116-fact-subject-renders-unquarantined.md) bounded subject header. Prior milestone: v0.3.12 *Memory that travels* — ✅ [Released 2026-08-02](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.12) ([plan](docs/v0.3.12-plan.md)). **v0.3.14** → **v0.4.0** follow, per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040).
