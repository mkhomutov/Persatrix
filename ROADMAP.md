...
> **Last updated**: 2026-07-21 (v0.3.11 — 🚧 **Release prep**: implementation complete; every live acceptance MT executed — `MT-AUTONOMOUS-001/002/003` pass, the four-vendor headline Accepted-with-known-gap ([ISSUE-0113](docs/issues/ISSUE-0113-four-vendor-shared-role-lanes-single-client-mismatch.md), slips per plan) — with three live-found fixes landed ([#763](https://github.com/mkhomutov/Persatrix/pull/763)). Remaining: version bump + final pre-tag sweep + tag. See the [release-prep plan](docs/v0.3.11-release-prep-plan.md).)
> **Current phase**: v0.3.11 (Conversations that run themselves — RFC 0052 autonomous channels + RFC 0053 Gemini/watsonx providers) — 🚧 Release prep
