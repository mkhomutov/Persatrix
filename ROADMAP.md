...
> **Last updated**: 2026-09-23 (the **EXP-001** harness has started: PR 1 of 6 reads the materials, prices each model call and draws the arm order — [#984](https://github.com/mkhomutov/Persatrix/pull/984), [harness plan](docs/experiments/EXP-001-harness.md). Before it, [ISSUE-0166](docs/issues/ISSUE-0166-manifest-omits-ungated-entries.md) was filed ([#983](https://github.com/mkhomutov/Persatrix/pull/983)). **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
