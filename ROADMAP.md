...
> **Last updated**: 2026-06-25 (v0.3.10 — RFC 0034 Phase 3 fold-in: `conversation_window.*` telemetry + the fetch-cache LRU bound; RFC 0034 ✅ Implemented. Next: v0.3.10 release-prep + tag.)
