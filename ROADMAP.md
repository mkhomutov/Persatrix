...
> **Last updated**: 2026-09-24 (**EXP-001** harness PR 4: arm A, one model call per meeting that reads the advisers in the persona agents' own words — [harness plan](docs/experiments/EXP-001-harness.md). PRs 1, 2, 3a and 3b merged. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
