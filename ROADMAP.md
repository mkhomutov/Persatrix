...
> **Last updated**: 2026-07-04 (v0.3.11 in progress — RFC 0052 PR 4b-ii: the goal-directed chair synthesis turn (close-on-reply) + OQ #6 close-summary metering. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
