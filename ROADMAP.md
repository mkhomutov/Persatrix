...
> **Last updated**: 2026-06-29 (v0.3.11 implementation began — RFC 0052 PR 1: the `autonomous` channel config block + mandatory-cost-cap gate, ships dark. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
