...
> **Last updated**: 2026-08-02 (post-v0.3.12 tail ratified per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040): **v0.3.13** *Deferred calls closed* (ISSUE-0114/0118/0121) → **v0.3.14** *One persona, many people* (ISSUE-0081/0082 + RFC 0040 Phase 1) → **v0.4.0** Agent Organizations.)
> **Current phase**: between milestones — v0.3.12 ✅ Released 2026-08-02; next **v0.3.13** (deferred calls: ISSUE-0114/0118/0121), then **v0.3.14** (multi-user isolation activation: ISSUE-0081/0082 + RFC 0040 Phase 1), then **v0.4.0** (Agent Organizations — RFC 0012 + RFC 0028 deliberative reasoning); the RFC 0041 typed-event drafts un-gate now the tag has shipped
> **Current milestone**: v0.3.12 *Memory that travels* — ✅ [Released 2026-08-02](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.12) ([plan](docs/v0.3.12-plan.md), opened 2026-07-25; [release-prep plan](docs/v0.3.12-release-prep-plan.md) — PRs 0–4 landed, Phase 4 tag + Release done). The headline user-facing story: **tell a persona something in one room and it knows it in every room it belongs to — without leaking what it learned in a confidential room.** Scope: **RFC 0037** (classification lattice + protection levels + the deterministic §D egress gate + §F recall filter — the keystone; Phases 2–3 projections/tripwire cuttable) + **RFC 0049 Phases 0–1** (the L1/fact-scope/topic-predicate widening amendments, shadow-first behind an RFC 0044 golden-trace measurement gate) **+ RFC 0039 Phases 1–2** (accounts/auth — `auth.mode` opt-in, console safe beyond localhost; bundled second workstream, independently shippable/cuttable). Fold-ins: ISSUE-0106 direction (b) ✅ + ISSUE-0114 (**cut to v0.3.13** — maintainer call at release-prep PR 2). Hard rule: **no widening merges before the 0037 gate is on `main`**. Prior milestone: v0.3.11 *Conversations that run themselves* — ✅ [Released 2026-07-22](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.11) ([v0.3.11-plan.md](docs/v0.3.11-plan.md)). **v0.3.13** → **v0.3.14** → **v0.4.0** follow, per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040).
