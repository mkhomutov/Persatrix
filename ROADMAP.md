...
> **Last updated**: 2026-07-14 (v0.3.11 — both headline RFCs (0052/0053) ✅ **Implemented**; the cuttable [RFC 0044 P1](docs/rfcs/0044-pr-plan.md) golden-trace eval fold-in is underway — PR 1 (format + assertion engine), PR 2 (replay LLM client), and PR 3 (runner + make targets + author guide) landed; seed goldens next (PR 4, gated on RFC 0041) — ahead of the live acceptance MTs + release-prep. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
