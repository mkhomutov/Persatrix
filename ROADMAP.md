...
> **Last updated**: 2026-09-18 (the all-sessions comments in `agents/`, ISSUE-0086 and the RFC 0031/0049 texts are corrected: the default prompt path reads facts and episodes across sessions behind the RFC 0037 §D gate, the other tiers stay session-scoped, and a new test lists every cross-session read and what guards it — [#971](https://github.com/mkhomutov/Persatrix/pull/971). **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
