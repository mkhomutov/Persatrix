...
> **Last updated**: 2026-09-23 (**EXP-001** harness PR 3a ([#987](https://github.com/mkhomutov/Persatrix/pull/987)): memory and the persona's clock read one agent time that a setting can shift to the story date — [harness plan](docs/experiments/EXP-001-harness.md). PRs 1 ([#984](https://github.com/mkhomutov/Persatrix/pull/984)) and 2 ([#986](https://github.com/mkhomutov/Persatrix/pull/986)) merged. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
