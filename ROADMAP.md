...
> **Last updated**: 2026-07-15 (v0.3.11 — both headline RFCs (0052/0053) ✅ **Implemented**; the cuttable [RFC 0044 P1](docs/rfcs/0044-pr-plan.md) golden-trace eval fold-in is underway — PRs 1–3 (format, replay client, runner) + two pre-0041 seed goldens landed: PR 4a EVAL-MEMORY-001 (dementia recall) and PR 4c EVAL-WORKING-001 (RFC 0034 working memory, via a driver conversation-window fetcher); the event-asserting seeds (PR 4b) stay gated on RFC 0041 — ahead of the live acceptance MTs + release-prep. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
> **Current phase**: v0.3.11 (Conversations that run themselves — RFC 0052 autonomous channels + RFC 0053 Gemini/watsonx providers) — 🚧 Implementing
> **Current milestone**: v0.3.11 *Conversations that run themselves* — 🚧 Implementing (RFC 0052 ✅ **Implemented** — all four phases, PRs 1–9, closed out at the PR 9 four-vendor headline; RFC 0053 ✅ **Implemented**. Both headline RFCs are done; the cuttable **RFC 0044 P1** golden-trace eval fold-in is now underway (PR 1: eval-set format + assertion engine), ahead of the live acceptance MTs + release-prep). The headline user-facing story: **give a roster of personas a topic and watch them discuss, converge, and synthesize with no human in the loop** — the human-out-of-the-loop capstone of the v0.3.7→v0.3.10 realism arc, and the project's best pre-v0.4.0 adoption demo. Autonomous behaviour is **opt-in per channel** and **cannot be created without an enforced cost cap**; ordinary human channels are byte-for-byte untouched (anti-collapse is `autonomous.enabled`-scoped). Scope: **RFC 0052 Phases 1–4** (convene + bounded brainstorm + mandatory cap → anti-collapse cadence → standing/scheduled → flagship demo) **+ RFC 0053** (Gemini + watsonx.ai providers, bundled/cuttable) for the four-vendor human-free brainstorm; **RFC 0044 P1** golden-trace eval rides as a cuttable safety-net fold-in. OQs locked at plan opening: distinct convener role, anti-collapse scoped to autonomous, the RFC 0020 closing summary metered (roster-scaled `1+N` synthesis reserve), Gemini via native `google-genai`. RFC 0039 *safe remote console* stays parallel → v0.3.12 candidate. See [v0.3.11-plan.md](docs/v0.3.11-plan.md), [RFC 0052 PR plan](docs/rfcs/0052-pr-plan.md), [RFC 0053 PR plan](docs/rfcs/0053-pr-plan.md), and the [v0.3.x-sequencing Amendment 2026-06-28](docs/v0.3.x-sequencing.md#amendment-2026-06-28--add-the-autonomous-agent-only-channel-as-the-v03x-realism-capstone). v0.4.0 (Agent Organizations — deliberative reasoning) follows.
...
| [#690](https://github.com/mkhomutov/Persatrix/pull/690) | docs(rfc): RFC 0051 — Reasoning Before Posting (private per-turn deliberation) | v0.3.10 plan | 2026-06-23 |
| [#691](https://github.com/mkhomutov/Persatrix/pull/691) | docs(v0310): open v0.3.10 planning — RFC 0051 Reasoning Before Posting | v0.3.10 plan | 2026-06-23 |
| [#692](https://github.com/mkhomutov/Persatrix/pull/692) | feat(agents): RFC 0051 PR 1 — structured silence verdict (dark) | 0051 reasoning (1) | 2026-06-23 |
| [#693](https://github.com/mkhomutov/Persatrix/pull/693) | feat(agents): RFC 0051 PR 2 — seam threading + agent.deliberated audit (dark) | 0051 reasoning (2) | 2026-06-24 |
| [#694](https://github.com/mkhomutov/Persatrix/pull/694) | feat(agents): RFC 0051 PR 3 — plan-threaded compose + no-leak test (dark) | 0051 reasoning (3) | 2026-06-24 |
| [#695](https://github.com/mkhomutov/Persatrix/pull/695) | feat(channels): RFC 0051 PR 4 — reasoning config backend (capability-gated, dark) | 0051 reasoning (4) | 2026-06-24 |
| [#696](https://github.com/mkhomutov/Persatrix/pull/696) | feat(cli,web): RFC 0051 PR 5 — reasoning config surfaces (enum + dotted-key) | 0051 reasoning (5) | 2026-06-24 |
| [#697](https://github.com/mkhomutov/Persatrix/pull/697) | feat(channels,agents): RFC 0051 PR 6 — reasoning go-live (off → bid flip + wire + telemetry) | 0051 reasoning (6/go-live) | 2026-06-24 |
| [#698](https://github.com/mkhomutov/Persatrix/pull/698) | feat(agents,channels): RFC 0051 PR 8 — reflexion loop (critic→revise, default off) | 0051 reasoning (8) | 2026-06-25 |
| [#699](https://github.com/mkhomutov/Persatrix/pull/699) | feat(agents,docs): RFC 0051 PR 9 — reflexion no-leak wall + revise telemetry + closeout (Phase 5b) | 0051 reasoning (9/close) | 2026-06-25 |
| [#700](https://github.com/mkhomutov/Persatrix/pull/700) | feat(agents,docs): RFC 0034 Phase 3 — conversation-window telemetry + fetch-cache LRU bound (v0.3.10) | 0034 P3 (fold-in) | 2026-06-25 |
| [#701](https://github.com/mkhomutov/Persatrix/pull/701) | feat(ci,agents,docs): RFC 0045 — MIT←BUSL←Private dependency-direction CI gate (v0.3.10) | 0045 CI gate (fold-in) | 2026-06-26 |
...
| [#704](https://github.com/mkhomutov/Persatrix/pull/704) | fix(agents,observability): ISSUE-0108 Gap A — surface stdlib extra= audit payload via ExtraAdder | 0051 obs fix | 2026-06-27 |
...
| [#708](https://github.com/mkhomutov/Persatrix/pull/708) | docs(release): post-release follow-up for v0.3.10 (this PR) | v0.3.10 post-release | 2026-06-28 |
