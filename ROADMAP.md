...
> **Last updated**: 2026-09-16 (the **External evidence check** ([#964](https://github.com/mkhomutov/Persatrix/pull/964)) — the first of the Amendment 2026-09-12's three mechanism PRs: `make amendment-evidence-check`, in the hook and `Docs hygiene`, fails an amendment from that date on whose evidence rows are missing or blank. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
