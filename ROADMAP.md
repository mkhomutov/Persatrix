...
| **v0.3.10** | Watch personas **think before they speak** — they stay silent (with a reason) when they have nothing to add (semantic silence, on by default once a channel is governed) and — one opt-in rung up, per channel — compose considered, plan-threaded posts instead of reflexive ones (RFC 0051 Phases 1–3 + 5) | 📋 Planned |
