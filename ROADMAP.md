...
> **Last updated**: 2026-06-19 (RFC 0036 recall PR 2: membership-scoped, epoch-filtered `RecallMessages` search query — the access-control join over `messages_fts` × `membership_intervals`. PR 1 merged; RFC 0035 ledger merged, PRs 1–4.)
