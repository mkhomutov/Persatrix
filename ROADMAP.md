...
> **Last updated**: 2026-08-19 (v0.3.14 *One persona, many people* — ✅ [**Released**](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.14); all four phases complete. Next: the **v0.4.0** train.)
> **Current phase**: **v0.4.0** *Agent Organizations* — 📋 next up (RFC 0012 organizations + RFC 0028 deliberative reasoning), per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040). Prior phase: v0.3.14 *One persona, many people* — ✅ [Released 2026-08-19](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.14).
