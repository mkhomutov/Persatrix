...
> **Last updated**: 2026-05-15 (v0.3.1 plan amendment — RFC 0034 Persona Conversational Working Memory absorbed; target `v0.3.1 (Phase 1) + v0.3.x (Phases 2–3)`, status `📋 Proposed`. Closes [ISSUE-0052](docs/issues/ISSUE-0052-persona-conversational-working-memory-gap.md). See [v0.3.1-plan §Amendment 2026-05-15](docs/v0.3.1-plan.md#amendment-2026-05-15--rfc-0034-conversational-working-memory).)
...
- **User accounts & authentication** — human accounts with password login, opaque revocable sessions, and a coarse operator/user role gate on the REST surface; the caller's `participant_id` becomes a verified claim (RFC 0039) — the human-identity counterpart to RFC 0009 agent identity and the principal RFC 0012 organizational clearance attaches to
...
| [0039](docs/rfcs/0039-user-accounts-authentication.md) | User Accounts & Authentication | Foundation: accounts store, password login, sessions, role gate (Phases 1–3) | 📋 Proposed |
