...
> **Last updated**: 2026-06-28 (v0.3.10 post-release follow-up — `v0.3.10` tagged + [GitHub Release](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.10) published; next phase v0.3.11 *safe remote console* (RFC 0039) → v0.4.0 *Agent Organizations*.)
