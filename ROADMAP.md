...
> **Last updated**: 2026-09-26 (CI builds and lints the Rust CLI on the release pinned in `cli/rust-toolchain.toml`, which Dependabot moves one release per PR; go-licenses and cargo-license install at versions pinned in the Makefile. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
