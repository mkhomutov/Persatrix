...
> **Last updated**: 2026-09-11 (RFC 0009's v0.3.0 row now says Partially Implemented, and its PR plan marks every v0.3.0 PR merged — [#907](https://github.com/mkhomutov/Persatrix/pull/907). **v0.3.16** Phase 1: [E1](https://github.com/mkhomutov/Persatrix/pull/893) merged 2026-09-09. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
