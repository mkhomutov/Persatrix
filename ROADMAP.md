...
> **Last updated**: 2026-04-19 (v0.2.0 released — first public release; v0.2.1 in progress)  
...
| **v0.2.1** | Chat with a persona agent from the terminal — the agent knows your name across sessions | 🚧 In Progress |
