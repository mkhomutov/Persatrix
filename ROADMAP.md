...
> **Last updated**: 2026-08-11 (v0.3.14 PRs 1–2 merged — the `persatrix-principal` rail is fed under `auth.mode: enabled`; PR 3 open, scoping GDPR erasure to the principal.)
