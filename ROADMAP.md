...
> **Last updated**: 2026-07-29 (RFC 0037 closeout — the v0.3.12 keystone ✅ implemented, all three phases; [RFC 0038](docs/rfcs/0038-concurrent-context-awareness-relay.md) §B ⚠️ partial via 0037 PR 4. With [RFC 0049](docs/rfcs/0049-memory-consolidation-gradient.md) P0–1 already live, the v0.3.12 headline is implemented; remaining: RFC 0039 PR 3 (maintainer-gated) + release-prep.)
> **Current phase**: v0.3.12 🚧 Implementing (headline RFCs 0037 + 0049 P0–1 ✅ done; remaining: RFC 0039 P1–2 tail (maintainer-gated) + release-prep live MTs); v0.4.0 (Agent Organizations) follows
