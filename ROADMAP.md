...
> **Current phase**: v0.3.12 🚧 Planning → implementation (RFC 0037 PR 1 + RFC 0039 PR 1 open in parallel; RFC 0049 slices gated on the 0037 §D gate + §F filter); v0.4.0 (Agent Organizations) follows
