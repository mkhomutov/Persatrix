...
> **Last updated**: 2026-06-04 (v0.3.7 planning opened — [v0.3.7 plan](docs/v0.3.7-plan.md), codename *Conversations worth watching*: realism cluster (RFC 0034 P2 group working memory + RFC 0030 relevance gate Tier A + disposition reframe + peer-voice prompt). Version Map v0.3.7 → 🚧 Planning; the [relevance amendment](docs/rfcs/0030-amendment-relevance-gated-response.md) is reconciled to the active Tier-A→v0.3.7 / Tier-B→v0.3.8 split.)
