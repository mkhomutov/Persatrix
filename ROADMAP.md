...
> **Last updated**: 2026-09-08 (**v0.3.16** Phase 1 opened — [D1](docs/v0.3.16-pr-plan.md#pr-d1--featurev0316-debt-memory-context) splits `memory_context.py`, the first debt-sweep PR; the [plan](docs/v0.3.16-plan.md) opened the same day with six [scope locks](docs/v0.3.16-scope-locks.md). Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
