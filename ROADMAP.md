...
> **Last updated**: 2026-07-13 (v0.3.11 in progress — RFC 0053 ✅ **Implemented** (PR 3 closeout: combined `providers` extra + provider-guide finalize; Gemini + watsonx already landed). RFC 0052 done through PR 8; the four-vendor headline + capstone closeout (PR 9) is the last remaining step. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
