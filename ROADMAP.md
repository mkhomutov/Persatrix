...
> **Last updated**: 2026-08-05 (v0.3.13 *Deferred calls closed* — ✅ [**Released**](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.13); all four phases complete. Next: the **v0.3.14** plan opens.)
> **Current phase**: **v0.3.14** *One persona, many people* — 📋 next up, plan opens per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040) (multi-user isolation activation: ISSUE-0081/0082 session-principal emission + RFC 0040 Phase 1, cuttable). Then **v0.4.0** (Agent Organizations — RFC 0012 + RFC 0028 deliberative reasoning). Prior phase: v0.3.13 *Deferred calls closed* — ✅ [Released 2026-08-05](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.13)
> **Current milestone**: v0.3.13 *Deferred calls closed* — ✅ [Released 2026-08-05](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.13) ([plan](docs/v0.3.13-plan.md) · [release-prep plan](docs/v0.3.13-release-prep-plan.md) — all four phases complete). The story: **the v0.3.12 promise holds everywhere it was made** — a persona's own memory-tool recalls obey the same epoch/session isolation as injected memory ([ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md), proven live with the tool round evidenced in provenance), the persona knows **who** it is talking to in a room it was never told ([ISSUE-0121](docs/issues/ISSUE-0121-crossroom-person-identity-legs-never-run-live.md) — legs 1b/2b ran for the first time and passed), and one channel's discussion length is tunable without retuning the fleet ([ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md)). Fold-in taken, not cut: [ISSUE-0116](docs/issues/ISSUE-0116-fact-subject-renders-unquarantined.md) bounded subject header. Prior milestone: v0.3.12 *Memory that travels* — ✅ [Released 2026-08-02](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.12). **Next milestone: v0.3.14** *One persona, many people* → then **v0.4.0**, per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040).
