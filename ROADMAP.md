...
> **Last updated**: 2026-06-08 (v0.3.8: deterministic governance Layers 1/2/4 landed — cost ceiling + reply budget + end-of-interaction vote, all opt-in — closing the [governance-layers PR plan](docs/rfcs/0030-governance-layers-pr-plan.md).)
