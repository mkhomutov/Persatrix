...
> **Last updated**: 2026-06-08 (v0.3.8: Tier B relevance salience closing out — the no-pile-on salience bid + `chair` facilitator + NL-addressing — alongside the landed deterministic governance Layers 1/2/4.)
