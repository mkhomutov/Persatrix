...
> **Last updated**: 2026-09-22 (a persona can edit and delete the notes it stored in a channel: the note store's edit, delete and count now read the channel's session, as its recall does — [ISSUE-0164](docs/issues/ISSUE-0164-persona-cannot-edit-or-delete-its-channel-notes.md), [#979](https://github.com/mkhomutov/Persatrix/pull/979). **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
