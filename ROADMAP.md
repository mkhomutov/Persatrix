...
> **Last updated**: 2026-09-18 (code comments no longer say the audience check and cross-room recall default to `shadow`; both default to `live` — [#970](https://github.com/mkhomutov/Persatrix/pull/970). **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
