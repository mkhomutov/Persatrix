...
> **Last updated**: 2026-06-04 (v0.3.6 **post-release follow-up** — `v0.3.6` tagged and the [GitHub Release "Web Console"](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.6) published 2026-06-04. Post-release ROADMAP hygiene: this `Last updated` refresh + the Merged PR History backfill for the full v0.3.6 cycle ([#492](https://github.com/mkhomutov/Persatrix/pull/492)–[#527](https://github.com/mkhomutov/Persatrix/pull/527)). v0.3.6 is ✅ Released; RFC 0048 stays `⚠️ Partially Implemented` (Slices 2–5 → v0.4.0+ / post-RFC 0039). **Planning update**: the v0.3.x tail is re-sequenced for conversation realism & usefulness ahead of v0.4.0 (new v0.3.7–v0.3.9 rows below) — see the [sequencing amendment](docs/v0.3.x-sequencing.md#amendment-2026-06-04--re-sequence-the-v03x-tail-for-conversation-realism--usefulness-ahead-of-v040) for the full rationale, the RFC 0037/0038 deferral, and the RFC 0028 reasoning rung.)
...
| **v0.3.7** | Watch several personas hold a group conversation that reads like colleagues, not bots — they see and build on the transcript (RFC 0034 P2), the right people speak, and a question to one isn't answered by everyone (RFC 0030 relevance gate Tier A + peer-voice prompt) | 📋 Planned |
