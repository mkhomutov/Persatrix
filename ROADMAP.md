...
> **Last updated**: 2026-06-09 (v0.3.8: interaction-summary surface closing out — a closed brainstorm now hands back its RFC 0020 summary in the web console + CLI; Tier B salience + governance Layers 1/2/4 already landed.)
> **Current phase**: v0.3.8 (Conversations that converge — RFC 0030 relevance Tier B + governance Layers 1/2/4 + interaction-summary surface) — 🚧 Implementing
> **Current milestone**: v0.3.8 *Conversations that converge* — 🚧 Implementing (deterministic governance Layers 1/2/4 landed; Tier B relevance salience functionally merged — PRs 1–3 — with its `chair`/docs closeout PR open; interaction-summary surface functionally merged — PRs 1–3 — with its docs closeout PR open). The headline user-facing story: **give a group of personas a problem and watch the brainstorm converge, terminate, and produce a readable synthesized outcome** — no pile-on ([RFC 0030 relevance Tier B](docs/rfcs/0030-amendment-relevance-gated-response.md) leased salience bid + the `chair` disposition + natural-language addressing), bounded cost and finite turns ([RFC 0030 Layers 1/2/4](docs/rfcs/0030-multi-agent-conversation-governance.md) cost ceiling + reply budget + end-of-interaction signal, all opt-in), and a real result (the [RFC 0020](docs/rfcs/0020-interaction-lifecycle.md) interaction summary surfaced at close). The `chair` ships as a low-threshold facilitator only — its moderator half (Layer 5) and declarative conversation types (Layer 6) remain v0.4.0 / v0.5.0+. The next phase is **v0.3.9** (conversations you can mine — verbatim recall).
...
| **v0.3.8** | Give a group of personas a problem and watch the brainstorm **converge, terminate, and produce a readable synthesized outcome** — no pile-on, bounded cost, a real result (RFC 0030 relevance Tier B salience + `chair` disposition + natural-language addressing + reply budget + cost ceiling + end-of-interaction + interaction-summary surface) | 🚧 Planning |
