...
| [0009](docs/rfcs/0009-security-sandboxing.md) | Agent Identity, Security & Sandboxing | v0.3.0 (Phases 1–2) + v0.4.0 (Phases 3–4) | 🚧 Implementing (PR 1 [#233](https://github.com/mkhomutov/Persatrix/pull/233) merged — audit logger + secret redactor; PR 1b open — orchestrator wiring) |
