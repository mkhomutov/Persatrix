...
> **Last updated**: 2026-08-02 (v0.3.12 *Memory that travels* — ✅ **[Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.12)**: tag + GitHub Release published, all four phases complete. Next: v0.3.13, carrying the three deferred calls — [ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md) (cut), [ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md), [ISSUE-0121](docs/issues/ISSUE-0121-crossroom-person-identity-legs-never-run-live.md) — then v0.4.0 Agent Organizations.)
> **Current phase**: between milestones — v0.3.12 ✅ Released 2026-08-02; **v0.3.13** (deferred-call cleanup) then **v0.4.0** (Agent Organizations — RFC 0012 + RFC 0028 deliberative reasoning); the RFC 0041 typed-event drafts un-gate now the tag has shipped
