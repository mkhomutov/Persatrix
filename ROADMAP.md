...
> **Last updated**: 2026-05-21 (v0.3.3 Phase 1 — RFC 0024 PR plan opened at [`docs/rfcs/0024-pr-plan.md`](docs/rfcs/0024-pr-plan.md). RFC 0024 frontmatter `target:` flipped to `v0.3.3 (Phases 1–4) + v0.4.0 (Phase 5) + v0.5+ (Phase 6)`; RFC Master Index row 0024 target column flipped to match. Version Map gains a v0.3.3 row at 🚧 Planning per [v0.3.3-plan §ROADMAP hygiene](docs/v0.3.3-plan.md#roadmap-hygiene). RFC status stays `📋 Proposed` — authoring a PR plan does not start implementation.)
> **Current phase**: v0.3.3 (Idle Truly Idle — RFC 0024 Phases 1–4) — 🚧 Planning
> **Current milestone**: v0.3.3 Phase 1 PR open — RFC 0024 PR plan filed at [`docs/rfcs/0024-pr-plan.md`](docs/rfcs/0024-pr-plan.md). Splits the work into 5 implementation PRs (Phase 1 EventLoop + SyncDispatchHandle, Phase 2 timer registry, Phase 3 split into 3a write-side prereqs + 3b SalienceWake, Phase 4 channel dispatch + cost-regression CI gate) plus review-follow-ups and Phases-1–4 closeout. Cost-regression CI gate from [RFC 0024 §Test Strategy](docs/rfcs/0024-event-driven-scheduling.md#test-strategy) is the release-blocker acceptance. Previous phase: v0.3.2 (Cost Gate + Facade Freeze — RFC 0023 full + RFC 0029 Phase 1) — ✅ released 2026-05-20.
...
| [0024](docs/rfcs/0024-event-driven-scheduling.md) | Event-Driven Agent Scheduling — wake the persona on inbound RPC, salience-triggered memory write, or scheduled timer instead of a fixed-interval poll; a persona with no scheduled work and no inbound traffic costs nothing. Closes the polling-loop cost-leak class structurally instead of patching it per release. PR plan: [`0024-pr-plan.md`](docs/rfcs/0024-pr-plan.md). (Slot 0024's original "Episodic Vector Recall" reservation was deferred, gated on [MT-MEMORY-005](docs/manual-tests/MT-MEMORY-005-dementia-test.md) data; the slot was reused for this RFC — see the [RFC 0029 numbering note](docs/rfcs/0029-personal-society-storage-split.md).) | v0.3.3 (Phases 1–4) + v0.4.0 (Phase 5) + v0.5+ (Phase 6) | 📋 Proposed |
