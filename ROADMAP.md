...
> **Last updated**: 2026-09-11 (plan-status now flags a "PR open" row that links no PR once its PR has merged; six stale closeout rows flipped — [#910](https://github.com/mkhomutov/Persatrix/pull/910). **v0.3.16** Phase 1: [E1](https://github.com/mkhomutov/Persatrix/pull/893) merged 2026-09-09. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
