...
> **Last updated**: 2026-09-17 (**EXP-001 is pre-registered** ([#969](https://github.com/mkhomutov/Persatrix/pull/969)): [its pre-registration](docs/experiments/EXP-001-preregistration.md) fixes the test plans, how each arm runs, the scoring, and the arithmetic that decides which decision rule fires, before any scored run; the harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
