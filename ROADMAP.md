...
> **Last updated**: 2026-09-15 (**v0.3.16** release prep — the live arc passed under both auth modes at release-prep [PR 1](https://github.com/mkhomutov/Persatrix/pull/954) (the §F recall side door [ISSUE-0158](docs/issues/ISSUE-0158-recall-filter-audience-blind.md) found and fixed in it); docs verified and the [release checklist](docs/v0.3.16-release-checklist.md) landed at [PR 2](https://github.com/mkhomutov/Persatrix/pull/956); PR 3 open — the bump to 0.3.16 and the dated `[0.3.16]` changelog. Final verification next. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
