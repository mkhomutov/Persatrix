...
> **Last updated**: 2026-07-12 (v0.3.11 in progress — RFC 0053 PR 2: IBM watsonx.ai as a first-class provider on the native `ibm-watsonx-ai` SDK (factory branch with fail-closed `project_id` + priced aliases + `make demo-watsonx` + redactor). RFC 0053 PR 1 (Gemini) merged; RFC 0052 done through PR 8. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
