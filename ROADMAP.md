...
> **Last updated**: 2026-09-16 (the doc checks share one **Markdown reader** ([#965](https://github.com/mkhomutov/Persatrix/pull/965)): doc links, plan status and ROADMAP status skip code fences and HTML comments as GitHub does, so a four-backtick block no longer hides the headings after it. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
