...
> **Last updated**: 2026-09-23 (filed [ISSUE-0166](docs/issues/ISSUE-0166-manifest-omits-ungated-entries.md): the RFC 0037 §G injection manifest lists only the entries the §D gate itself judged, so one that reached the prompt without passing the gate is dropped from the record rather than flagged — an audit-record gap, no production code changed — [#983](https://github.com/mkhomutov/Persatrix/pull/983). Before it, MT-EPOCH-001 and MT-SESSION-001 moved to saying a CLI call carries the epoch or session its own shell sets ([#981](https://github.com/mkhomutov/Persatrix/pull/981), [#982](https://github.com/mkhomutov/Persatrix/pull/982)). **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
