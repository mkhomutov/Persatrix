...
> **Last updated**: 2026-07-09 (v0.3.11 in progress — RFC 0052 PR 7c-ii-a: the convener-side `ScheduledWake(convene)` → `/convene` wake handler (dark). See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
