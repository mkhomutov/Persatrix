...
> **Last updated**: 2026-06-02 (v0.3.6 **planning opened** — Phase 0 of [v0.3.6-plan.md](docs/v0.3.6-plan.md) (codename *Web Console*). This PR lands the v0.3.6 master plan and opens the planning phase: adds the [§Version Map](#version-map) v0.3.6 row (`🚧 Planning`) and refreshes this header / `Current phase` / `Current milestone`. v0.3.6 ships RFC 0048 Phase 1 / Slice 1 — the embedded same-origin web console (chat + channel timeline behind `--enable-ui`, off by default); the implementation workstream is the standalone [RFC 0048 Phase 1 PR plan](docs/rfcs/0048-phase1-pr-plan.md) (6 PRs), which this master plan wraps with the release-prep + tag phases. **No RFC Master Index edit** here — RFC 0048 has no Master Index row yet (added by the phase-1 plan's PR 6 at closeout) and stays `👍 Accepted` until Phase 1 PR 1 opens. The prior milestone v0.3.5 *Session-Scoped Memory* is ✅ Released ([GitHub Release](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.5), tagged 2026-06-01): RFC 0031 Phases 2–4 + the epoch run-isolation axis ([#448](https://github.com/mkhomutov/Persatrix/pull/448)–[#478](https://github.com/mkhomutov/Persatrix/pull/478)) and RFC 0033 Phase 3 ([#481](https://github.com/mkhomutov/Persatrix/pull/481)–[#486](https://github.com/mkhomutov/Persatrix/pull/486)). Next phase after v0.3.6 is v0.4.0 (team/hierarchy).)
