...
> **Last updated**: 2026-09-12 (the channels guide's §13 *Autonomous channels* is now its own [guide](docs/guides/autonomous-channels.md) — [#937](https://github.com/mkhomutov/Persatrix/pull/937). **v0.3.16** Phase 1: [E1](https://github.com/mkhomutov/Persatrix/pull/893) merged 2026-09-09. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
