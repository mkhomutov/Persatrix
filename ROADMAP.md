...
> **Last updated**: 2026-07-11 (v0.3.11 in progress — RFC 0053 PR 1: Google Gemini as a first-class provider on the native `google-genai` SDK (factory branch + priced aliases + `make demo-gemini` + redactor). RFC 0052 done through PR 8. See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
