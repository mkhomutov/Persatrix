...
> **Last updated**: 2026-06-07 (v0.3.8 *Conversations that converge* planning opened — [plan](docs/v0.3.8-plan.md); codename locked; `chair` disposition + natural-language addressing scoped IN.)
