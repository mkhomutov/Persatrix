...
> **Last updated**: 2026-09-23 (MT-EPOCH-001 and MT-SESSION-001 now scope a run from the shell the CLI runs in; starting the persona under `PERSATRIX_EPOCH` or `PERSATRIX_SESSION_ID` scopes no channel turn — [#981](https://github.com/mkhomutov/Persatrix/pull/981) and its follow-up. **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
