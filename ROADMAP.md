...
> **Last updated**: 2026-08-03 (v0.3.13 implementation opened — PR 1 lands the [ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md) tool-recall scope threading; v0.3.13 → 🔄 In progress.)
