...
> **Last updated**: 2026-09-24 (**EXP-001** harness PR 5a: arms B and C hold each meeting on a local deployment of the four advisers and end it with the memo turn — [harness plan](docs/experiments/EXP-001-harness.md). PRs 1 to 4 merged. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
