...
> **Last updated**: 2026-07-30 (RFC 0039 closeout — Phases 1–2 ⚠️ shipped: `auth.mode: enabled` makes the console/REST surface safe beyond localhost over HTTPS; [amendment](docs/rfcs/0039-amendment-enabled-mode-exposure.md) ✅; new [auth guide](docs/guides/auth.md). All three v0.3.12 workstreams implemented; remaining: release-prep.)
> **Current phase**: v0.3.12 🚧 Implementing (RFCs 0037 + 0049 P0–1 + 0039 P1–2 ✅ all implemented; remaining: release-prep live MTs); v0.4.0 (Agent Organizations) follows
