...
> **Last updated**: 2026-07-21 (v0.3.11 — ✅ **all pre-tag gates green** (release-prep PRs 0–4; live MTs executed, three live-found fixes landed, the four-vendor governed-bidding gap slips as [ISSUE-0113](docs/issues/ISSUE-0113-four-vendor-shared-role-lanes-single-client-mismatch.md)); the mechanical `v0.3.11` tag + GitHub Release are the remaining Phase-4 step. See the [release-prep plan](docs/v0.3.11-release-prep-plan.md).)
> **Current phase**: v0.3.11 (Conversations that run themselves — RFC 0052 autonomous channels + RFC 0053 Gemini/watsonx providers) — ✅ Released (tag = Phase 4)
