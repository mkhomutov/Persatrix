...
> **Last updated**: 2026-07-08 (v0.3.11 in progress — RFC 0052 PR 7c-i: the config-round-trip timer producer (`StandingConveneTimers`, dark). See [v0.3.11-plan.md](docs/v0.3.11-plan.md).)
