...
> **Last updated**: 2026-09-16 (**v0.3.16** — ✅ **all pre-tag gates green** at release-prep PR 4, re-run after [#959](https://github.com/mkhomutov/Persatrix/pull/959) fixed the offline demo's monologue; version bumped at [PR 3](https://github.com/mkhomutov/Persatrix/pull/957). The tag is next. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
