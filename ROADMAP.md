...
> **Last updated**: 2026-09-24 (**EXP-001** harness PR 3b: prompt caching in the Anthropic adapter, each meeting's clock, and a call log that tags every model call — [harness plan](docs/experiments/EXP-001-harness.md). PRs 1, 2 and 3a merged. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
