...
> **Last updated**: 2026-09-11 (the Docker demo stack's agent and observability ports are off the network too — [#934](https://github.com/mkhomutov/Persatrix/pull/934). **v0.3.16** Phase 1: [E1](https://github.com/mkhomutov/Persatrix/pull/893) merged 2026-09-09. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
