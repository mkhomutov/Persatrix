...
| **v0.3.10** | Watch personas **think before they speak** — they stay silent (with a reason) when they have nothing to add and compose considered, plan-threaded posts instead of reflexive ones, live-tunable per channel (RFC 0051 Phases 1–3 + 5) | 📋 Planned |
