...
> **Last updated**: 2026-09-18 (filed [ISSUE-0163](docs/issues/ISSUE-0163-withheld-episodes-reinforced-before-the-gate.md): the default episodic recall counts episodes the gate withholds as used, so they climb the ranking and hold recall slots; its fix, draft [#972](https://github.com/mkhomutov/Persatrix/pull/972), is held behind **EXP-001**. **EXP-001** is pre-registered ([#969](https://github.com/mkhomutov/Persatrix/pull/969)); its harness under `evaluators/` comes next. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
