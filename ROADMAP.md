...
> **Last updated**: 2026-09-12 (filed [ISSUE-0156](docs/issues/ISSUE-0156-standing-timer-unbounded.md): a convene timer can re-open an autonomous channel that declares no aggregate bound — [#938](https://github.com/mkhomutov/Persatrix/pull/938). **v0.3.16** Phase 1: [E1](https://github.com/mkhomutov/Persatrix/pull/893) merged 2026-09-09. Prior: v0.3.15 ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.15) at `a85e4604`.)
