...
> **Last updated**: 2026-08-05 (v0.3.13 — ✅ **all pre-tag gates green** (release-prep PRs 0–4); the mechanical `v0.3.13` tag + GitHub Release are the remaining Phase-4 step. See the [release-prep plan](docs/v0.3.13-release-prep-plan.md).)
> **Current phase**: v0.3.13 *Deferred calls closed* (ISSUE-0118 tool-recall scopes + ISSUE-0121 person-identity legs live + ISSUE-0114 per-channel cascade depth, with the ISSUE-0116 fold-in) — ✅ Released (tag = Phase 4). Then **v0.3.14** (multi-user isolation activation: ISSUE-0081/0082 + RFC 0040 Phase 1), then **v0.4.0** (Agent Organizations — RFC 0012 + RFC 0028 deliberative reasoning)
> **Current milestone**: v0.3.13 *Deferred calls closed* — ✅ Released ([plan](docs/v0.3.13-plan.md) · [release-prep plan](docs/v0.3.13-release-prep-plan.md) — PRs 0–4 landed, tag = Phase 4). The story: **the v0.3.12 promise holds everywhere it was made** — a persona's own memory-tool recalls obey the same epoch/session isolation as injected memory ([ISSUE-0118](docs/issues/ISSUE-0118-tool-recall-bypasses-epoch-session-scopes.md), proven live with the tool round evidenced in provenance), the persona knows **who** it is talking to in a room it was never told ([ISSUE-0121](docs/issues/ISSUE-0121-crossroom-person-identity-legs-never-run-live.md) — legs 1b/2b ran for the first time and passed), and one channel's discussion length is tunable without retuning the fleet ([ISSUE-0114](docs/issues/ISSUE-0114-per-channel-cascade-depth-override.md)). Fold-in taken, not cut: [ISSUE-0116](docs/issues/ISSUE-0116-fact-subject-renders-unquarantined.md) bounded subject header. Prior milestone: v0.3.12 *Memory that travels* — ✅ [Released 2026-08-02](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.12). **v0.3.14** → **v0.4.0** follow, per the [sequencing Amendment 2026-08-02](docs/v0.3.x-sequencing.md#amendment-2026-08-02--v0313--v0314-the-two-release-tail-to-v040).
