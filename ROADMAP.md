...
> **Last updated**: 2026-09-17 (the **file-size gate** follows ruling (e) of the [sequencing Amendment 2026-09-12](docs/v0.3.x-sequencing.md#amendment-2026-09-12--close-v0316-small-then-measure-before-any-train-opens): a code file gets a warning over 500 lines and fails only over 800, and the debt sweep is retired. **v0.3.16** ✅ [Released](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.16); no next plan opens before **EXP-001** and the first strategy review.)
