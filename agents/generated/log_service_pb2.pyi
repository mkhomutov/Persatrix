...
class LogBatch(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["agent_id", b"agent_id", "entries", b"entries"]) -> None: ...
...
class LogEntry(google.protobuf.message.Message):
    ...
    class Source(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["file", b"file", "function", b"function", "line", b"line"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["attributes", b"attributes", "source", b"source", "timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["agent_id", b"agent_id", "attributes", b"attributes", "execution_id", b"execution_id", "level", b"level", "message", b"message", "request_id", b"request_id", "schema_version", b"schema_version", "service_instance", b"service_instance", "service_kind", b"service_kind", "service_role", b"service_role", "source", b"source", "span_id", b"span_id", "step_id", b"step_id", "timestamp", b"timestamp", "trace_id", b"trace_id"]) -> None: ...
...
class LogAck(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["received_through_seq", b"received_through_seq"]) -> None: ...
