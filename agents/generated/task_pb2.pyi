...
class ChannelMessageEvent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["channel_id", b"channel_id", "channel_type", b"channel_type", "content", b"content", "mentions", b"mentions", "message_id", b"message_id", "respond_policy", b"respond_policy", "sender_id", b"sender_id", "thread_id", b"thread_id", "thread_parent_sender_id", b"thread_parent_sender_id", "timestamp", b"timestamp"]) -> None: ...
