...
class ChannelMessageEvent(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_threshold", b"_threshold", "cascade_depth", b"cascade_depth", "channel_id", b"channel_id", "channel_size", b"channel_size", "channel_type", b"channel_type", "content", b"content", "floor_mentions", b"floor_mentions", "floor_mentions_resolved", b"floor_mentions_resolved", "interaction_id", b"interaction_id", "mentions", b"mentions", "message_id", b"message_id", "respond_policy", b"respond_policy", "salience_gated", b"salience_gated", "salience_max_channel_members", b"salience_max_channel_members", "sender_id", b"sender_id", "sender_participant_type", b"sender_participant_type", "thread_id", b"thread_id", "thread_parent_sender_id", b"thread_parent_sender_id", "threshold", b"threshold", "timestamp", b"timestamp"]) -> None: ...
