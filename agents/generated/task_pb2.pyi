...
class ChannelMessageEvent(google.protobuf.message.Message):
    ...
    FLOOR_MENTIONS_FIELD_NUMBER: builtins.int
    FLOOR_MENTIONS_RESOLVED_FIELD_NUMBER: builtins.int
    PREVIOUS_INTERACTION_ID_FIELD_NUMBER: builtins.int
    PREVIOUS_INTERACTION_CLOSE_TRIGGER_FIELD_NUMBER: builtins.int
    CHAIR_ESCALATION_FIELD_NUMBER: builtins.int
    INTERACTION_CLOSE_NOTIFICATION_FIELD_NUMBER: builtins.int
    CHAIR_ESCALATION_RESYNTHESIZE_FIELD_NUMBER: builtins.int
    REASONING_MODE_FIELD_NUMBER: builtins.int
    REASONING_REVISE_FIELD_NUMBER: builtins.int
    CONVENE_FIELD_NUMBER: builtins.int
    CLOSE_NOTIFICATION_REDELIVERY_FIELD_NUMBER: builtins.int
    CLOSE_NOTIFICATION_CLOSE_TRIGGER_FIELD_NUMBER: builtins.int
    SYNTHESIS_TURN_FIELD_NUMBER: builtins.int
    ...
    """
    floor_mentions_resolved: builtins.bool
    ...
    """
    previous_interaction_id: builtins.str
    ...
    `interaction_id = 17`.
    """
    previous_interaction_close_trigger: builtins.str
    ...
    """
    chair_escalation: builtins.bool
    ...
    """
    chair_escalation_resynthesize: builtins.bool
    ...
    """
    close_notification_redelivery: builtins.bool
    ...
    """
    close_notification_close_trigger: builtins.str
    ...
    def __init__(
        ...
        *,
        ...
        salience_max_channel_members: builtins.int = ...,
        interaction_id: builtins.str = ...,
        floor_mentions: collections.abc.Iterable[builtins.str] | None = ...,
        floor_mentions_resolved: builtins.bool = ...,
        previous_interaction_id: builtins.str = ...,
        previous_interaction_close_trigger: builtins.str = ...,
        chair_escalation: builtins.bool = ...,
    ...
    def ClearField(self, field_name: typing.Literal["_threshold", b"_threshold", "cascade_depth", b"cascade_depth", "chair_escalation", b"chair_escalation", "chair_escalation_resynthesize", b"chair_escalation_resynthesize", "channel_id", b"channel_id", "channel_size", b"channel_size", "channel_type", b"channel_type", "classification", b"classification", "close_notification_close_trigger", b"close_notification_close_trigger", "close_notification_redelivery", b"close_notification_redelivery", "content", b"content", "convene", b"convene", "floor_mentions", b"floor_mentions", "floor_mentions_resolved", b"floor_mentions_resolved", "interaction_close_notification", b"interaction_close_notification", "interaction_id", b"interaction_id", "mentions", b"mentions", "message_id", b"message_id", "previous_interaction_close_trigger", b"previous_interaction_close_trigger", "previous_interaction_id", b"previous_interaction_id", "reasoning_mode", b"reasoning_mode", "reasoning_revise", b"reasoning_revise", "respond_policy", b"respond_policy", "salience_gated", b"salience_gated", "salience_max_channel_members", b"salience_max_channel_members", "sender_id", b"sender_id", "sender_participant_type", b"sender_participant_type", "synthesis_turn", b"synthesis_turn", "thread_id", b"thread_id", "thread_parent_sender_id", b"thread_parent_sender_id", "threshold", b"threshold", "timestamp", b"timestamp"]) -> None: ...
