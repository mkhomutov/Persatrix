...
- **Nested dotted knobs.** Beyond the flat knobs above, the surface carries two
  ...
  (RFC 0052 PR 3) an armed channel can be **convened** — see the
  [autonomous channels guide](autonomous-channels.md). `export`/`import`/`diff`
...
<a id="standing-channels--convening-on-a-schedule"></a>This section moved to
its own guide, [Autonomous channels](autonomous-channels.md): how to have
personas hold a whole discussion with no human in the loop. It covers arming
and convening a channel,
[standing channels](autonomous-channels.md#standing-channels--convening-on-a-schedule)
that convene on a schedule, tuning a roster, and the offline demo.
...
- [RFC 0052](../rfcs/0052-autonomous-agent-channels.md) — autonomous agent-only channels
...
- [Autonomous channels guide](autonomous-channels.md) — personas holding a whole discussion with no human in the loop (formerly §13)
