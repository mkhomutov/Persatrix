...
## Resolution — (a) shipped in v0.3.14; (b) is v0.3.15 (B1 + B2)
...
## (b) — required in v0.3.15 — landed as B1 + B2
...
The dated build log — the sequencing decisions, the per-PR scope locks and
