# ISSUE-0082 Part 2 — the v0.3.14 build log (record)

**Companion to**: [ISSUE-0082](ISSUE-0082-orchestrator-per-request-session-principal-emission.md)
**Covers**: 2026-08-03 → 2026-08-06 — Part 2 scoping through the PR 2 producer review
**Release**: v0.3.14 *One persona, many people* — ✅ [Released 2026-08-19](https://github.com/mkhomutov/Persatrix/releases/tag/v0.3.14)

The dated PR-by-PR diary of Part 2's implementation, split out of ISSUE-0082
on 2026-08-23 when the residuals note pushed that file past the 3 000-word
prose cap (`scripts/checks/file_size.py --strict`). Same split-not-allowlist
choice the [Phase 0 gate record](ISSUE-0082-residuals-phase0-gate.md) was made
with, and the same reason: the parent should stay the *issue*, not the build
log of a shipped release.

Nothing here is a live decision. The scope locks these notes record are in the
[v0.3.14 plan](../v0.3.14-plan.md); what shipped is in the
[release checklist](../v0.3.14-release-checklist.md) and the
[execution report](../manual-tests/v0.3.14-execution-report.md). The residuals
these PRs left open — R-1, R-2 — stay on the parent and are planned in the
[residuals PR plan](ISSUE-0082-residuals-pr-plan.md).
