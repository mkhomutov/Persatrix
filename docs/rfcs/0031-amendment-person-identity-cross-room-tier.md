...
**Status**: 🚧 In progress — **PR D1 (storage foundation) + D2 (write-through + render) implemented**; D3 (backfill + Option-A retirement) remains. Target **v0.3.x** (deliberately not v0.3.8). Tracks [ISSUE-0093](../issues/ISSUE-0093-person-identity-cross-room-tier.md) (F-7 Option D).
