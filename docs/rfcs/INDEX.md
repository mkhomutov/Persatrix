...
> 26 in-flight · 25 implemented/stable · 0 deferred · auto-generated by `make rfcs` (do not hand-edit between markers).
...
| [RFC-0044](0044-eval-set-golden-traces.md) | 🚧 Implementing | process | v0.3.11 (Phase 1 format + replay) + v0.3.16 (Phase 2 CI gate, cuttable) + v0.4.0+ (typed-event goldens, gated on RFC 0041 Phase 1) | 2026-05-20 | Eval-Set Shape with Golden Traces |
...
| [RFC-0046](0046-budget-lease-extraction.md) | 📋 Proposed | architecture | not standalone — rides the governance-core extraction, if any; decided at the first strategy review (Amendment 2026-09-12) | 2026-05-25 | Budget-Lease Library Extraction (persatrix-budget) |
...
| [RFC-0031](0031-per-session-namespacing-channels.md) | ✅ Implemented | architecture | v0.3.1 (P1) + v0.3.5 (P2–4) | 2026-05-12 | Per-Session Namespacing for Channels and Persona Memory |
| [RFC-0033](0033-model-alias-layer.md) | ✅ Implemented | architecture | v0.3.4 (Phases 1–2) + v0.3.5 (Phase 3) | 2026-05-15 | Provider-Agnostic Model Alias Layer |
| [RFC-0034](0034-persona-conversational-working-memory.md) | ✅ Implemented | architecture | v0.3.1 (Phase 1) + v0.3.7 (Phase 2 — group working memory) + v0.3.10 (Phase 3 — instrumentation + cache LRU bound) | 2026-05-15 | Persona Conversational Working Memory |
| [RFC-0035](0035-channel-membership-interval-ledger.md) | ✅ Implemented | architecture | v0.3.9 | 2026-05-16 | Channel Membership Interval Ledger |
| [RFC-0036](0036-persona-message-recall.md) | ✅ Implemented | feature | v0.3.9 | 2026-05-16 | Persona Verbatim Message Recall |
| [RFC-0037](0037-memory-confidentiality-channel-classification.md) | ✅ Implemented | feature | v0.3.12 (cross-channel persona experience; pulled forward from the v0.4.0 on-ramp per 2026-07-15) | 2026-05-16 | Memory Confidentiality & Channel Classification |
| [RFC-0050](0050-extensible-channel-configuration.md) | ✅ Implemented | architecture | v0.3.x (unscheduled) | 2026-06-14 | Extensible Channel Configuration (Operator-Editable, Single Source of Truth) |
| [RFC-0051](0051-reasoning-before-posting.md) | ✅ Implemented | feature | v0.3.10 | 2026-06-22 | Reasoning Before Posting |
| [RFC-0052](0052-autonomous-agent-channels.md) | ✅ Implemented | feature | v0.3.11 | 2026-06-28 | Autonomous Agent-Only Channels |
| [RFC-0053](0053-gemini-watsonx-providers.md) | ✅ Implemented | feature | v0.3.11 | 2026-06-28 | Gemini and watsonx.ai LLM Providers |
<!-- END rfcs:auto -->
