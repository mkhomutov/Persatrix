...
> 30 in-flight · 15 implemented/stable · 0 deferred · auto-generated by `make rfcs` (do not hand-edit between markers).
...
| [RFC-0031](0031-per-session-namespacing-channels.md) | ⚠️ Partially Implemented | architecture | v0.3.1 (P1) + v0.3.5 (P2) + v0.3.x (P3–4) | 2026-05-12 | Per-Session Namespacing for Channels and Persona Memory |
| [RFC-0033](0033-model-alias-layer.md) | ⚠️ Partially Implemented | architecture | v0.3.4 (Phases 1–2) + v0.3.5+ (Phase 3) | 2026-05-15 | Provider-Agnostic Model Alias Layer |
