...
| 2 | Sessions table + Go migrations + orchestrator env-var | `feature/v031-rfc0031p1-sessions-table-go` | 🔀 PR open | [#335](https://github.com/mkhomutov/Persatrix/pull/335) | — |
