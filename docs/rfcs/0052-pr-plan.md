...
| 7c-i | 3 — config-round-trip timer producer: `StandingConveneTimers` (dark) | `…-standing-timer` | 🔀 PR open |
| 7c-ii | 3 — `agents.yaml` timer writer + convener `ScheduledWake(convene)`→`ConveneChannel` + `MT-AUTONOMOUS-003` | `…-standing-timer-fire` | ⬜ |
