...
- **Resolved (PR 4b-ii, PR #718 review).** ~~[PR 5 / defense-in-depth] Gate the redelivery ingest-skip on `bounded`.~~ `close_notification.py` now co-gates the skip (`redelivery and bounded`).
