...
| Experiments | `docs/experiments/EXP-NNN-preregistration.md` and `EXP-NNN-result.md`, the path strategy §4 names | The pre-registration changes only through a PR that says why, and freezes when the first scored run starts; the result is written once | — |
