...
GRANDFATHERED_FILES: frozenset[str] = frozenset({
    ...
    # the cap takes at least three more splits, each leaving a ~50-word stub:
    # §4, the response gate and its governance subsections (3 926 words, over
    # the cap on its own), §2, declaring channels (1 021), and one more.
    # Grandfather here until those land.
