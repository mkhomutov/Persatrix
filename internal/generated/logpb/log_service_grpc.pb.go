...
const (
	LogService_StreamLogs_FullMethodName = "/persatrix.v1.LogService/StreamLogs"
)
...
func (c *logServiceClient) StreamLogs(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[LogBatch, LogAck], error) {
...
type LogService_StreamLogsClient = grpc.BidiStreamingClient[LogBatch, LogAck]
...
func (UnimplementedLogServiceServer) StreamLogs(grpc.BidiStreamingServer[LogBatch, LogAck]) error {
...
func _LogService_StreamLogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(LogServiceServer).StreamLogs(&grpc.GenericServerStream[LogBatch, LogAck]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LogService_StreamLogsServer = grpc.BidiStreamingServer[LogBatch, LogAck]

// LogService_ServiceDesc is the grpc.ServiceDesc for LogService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var LogService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "persatrix.v1.LogService",
