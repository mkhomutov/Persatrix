...
type ClosedInteractionsRequest struct {
	...
	MinTurns      int32 `protobuf:"varint,5,opt,name=min_turns,json=minTurns,proto3" json:"min_turns,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ClosedInteractionsRequest) GetMinTurns() int32 {
	if x != nil {
		return x.MinTurns
	}
	return 0
...
func (x *ClosedInteraction) GetParticipants() []string {
	if x != nil {
...
const file_task_proto_rawDesc = "" +
	...
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\xa6\x01\n" +
